...
const VehicleOfficerSidebar = () => {
  ...
  const navLinks = [
    { href: "/find-company", label: "Find Company" },
    { href: "/request-items", label: "Request Items" },
    { href: "/request-vehicle", label: "Request Vehicle" },
    { href: "/edit-driver", label: "Edit-Driver/Vehicle Information" },
    { href: "/inventory-form", label: "Inventory Form" },
  ];
...
export default VehicleOfficerSidebar;