...
const SupervisorSidebar = () => {
  ...
  const navLinks = [
    { href: "/supervisor/request-items", label: "Request Items" },
    { href: "/supervisor/request-vehicle", label: "Request Vehicle" },
    { href: "/supervisor/find-company", label: "Find Company" },
    { href: "/supervisor/inventory-form", label: "Inventory Form" },
    { href: "/supervisor/add-facility", label: "Add Facility" },
  ];
